 ...
 */
public class NavigationDrawerFragment extends Fragment implements blackcat.tubedown.drawer.NavigationDrawerCallbacks {
    ...
    public List<NavigationItem> getMenu() {
        ...
        items.add(new NavigationItem("다운로드목록", getResources().getDrawable(R.drawable.ic_list_black)));
        return items;
    }

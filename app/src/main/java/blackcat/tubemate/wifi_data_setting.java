...
public class wifi_data_setting extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(blackcat.tubemate.R.layout.wifi_data_setting);
        preferenceManager  = PreferenceManager.getDefaultSharedPreferences(this);
        PrefEdit = preferenceManager.edit();
        mWifi_switch = (Switch) findViewById(blackcat.tubemate.R.id.wifi_switch);
        mData_switch = (Switch) findViewById(blackcat.tubemate.R.id.data_switch);
        mWifi_Data_switch = (Switch) findViewById(blackcat.tubemate.R.id.wifi_data_switch);
    ...
    private void select() {
        mFilepath_text = (TextView)SettingFragment.Setting_temp.findViewById(blackcat.tubemate.R.id.wifi_data_txt);
        switch (wifi_data){
            case 0:
                temp = "와이파이";
                break;

...
import blackcat.tubemate.service.InterfaceMapping;
...
public class SettingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(blackcat.tubemate.R.layout.activity_setting, null);
        ...
        mMoveadmin_LL = (LinearLayout)view.findViewById(blackcat.tubemate.R.id.move_admin_btn);
        ...
        mHowtoUse_LL = (LinearLayout)view.findViewById(blackcat.tubemate.R.id.use_info_btn);
        ...
        mFilePath_LL = (LinearLayout)view.findViewById(blackcat.tubemate.R.id.file_path_btn);
        ...
        mFilepath_text = (TextView)view.findViewById(blackcat.tubemate.R.id.file_path_txt);
        mFilepath_text.setText("저장파일선택 :" + temp);

        minternet_LL = (LinearLayout) view.findViewById(blackcat.tubemate.R.id.wifi_data_btn);
        mWifi_Data_text = (TextView) view.findViewById(blackcat.tubemate.R.id.wifi_data_txt);

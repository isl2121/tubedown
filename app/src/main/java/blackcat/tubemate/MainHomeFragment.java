...
public class MainHomeFragment extends Fragment{
    ...
    public Button mAvi_button, mMp3_button;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(blackcat.tubemate.R.layout.activity_main_home, null);
        progressDialog = (ProgressBar) view.findViewById(blackcat.tubemate.R.id.loading_bar);
        ...
        first_help = (ImageView) view.findViewById(blackcat.tubemate.R.id.first_help);
        if(first_check) {
            First_alram();
        }else{
        ...
        mWebView = (WebView) view.findViewById(blackcat.tubemate.R.id.webview_youtube);
        mWebView.getSettings().setJavaScriptEnabled(true);
        mWebView.loadUrl("http://www.youtube.com/");
        mWebView.setWebViewClient(new WishWebViewClient());
        mAvi_button = (Button) view.findViewById(blackcat.tubemate.R.id.mp4_button);
        mMp3_button = (Button) view.findViewById(blackcat.tubemate.R.id.m4a_button);

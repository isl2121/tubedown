...
import blackcat.tubemate.drawer.NavigationDrawerCallbacks;
import blackcat.tubemate.drawer.NavigationDrawerFragment;
...
public class MainActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(blackcat.tubemate.R.layout.activity_main);
        ...
        mNavigationDrawerFragment = (NavigationDrawerFragment)
                getFragmentManager().findFragmentById(blackcat.tubemate.R.id.fragment_drawer);
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        fragmentManager.beginTransaction()
                .replace(blackcat.tubemate.R.id.container, fragmentToReplace)
                .commit();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == blackcat.myapplication.R.id.action_settings) {
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(blackcat.myapplication.R.layout.fragment_main, container, false);
            return rootView;
        }
